...
<html>
    <head>
        ...
        <title><?php echo get_phrase('Logare');?> | <?php echo $system_title;?></title>
    </head>
	<body>
        <div id="main_body">
                ...
                <div class="navbar-inner">
                    <div class="container-fluid">
                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Alege limba <b class="caret"></b></a>
                            <!-- Language Selector -->
                    ...
                    <div class="padded">
                        ...
                        <div class="login box" style="margin-top: 10px;">
                            <div class="box-header">
                                <span class="title"><?php echo get_phrase('Logare');?></span>
                            </div>
                            ...
                            <script>
                                function check_account_type()
                                {
                                    ...
                                    if (account_type == "") {
                                        Growl.info({title:"Selecteaza un cont prima data",text:" "})
                                ...
                                <?php echo form_open('login' , array('class' => 'separate-sections', 'onsubmit' => 'return check_account_type()'));?>
                                    ...
                                    <div class="">
                                        <select id="account_selector" class="validate[required]" name="login_type" style="width:100%;margin-bottom:0px !important;" >
                                            <option value=""><?php echo get_phrase('Selecteaza cont');?></option>
                                            <option value="admin"><?php echo get_phrase('Administrator');?></option>
                                            <option value="teacher"><?php echo get_phrase('Profesor');?></option>
                                            <option value="student"><?php echo get_phrase('Elev');?></option>
                                            <option value="parent"><?php echo get_phrase('Parinte');?></option>
                                        </select>
                                    </div>
                                    <style>
                                    .flip_in{
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="email" type="text" placeholder="<?php echo get_phrase('Adresa email');?>" autocomplete="off">
                                    </div>
                                    <div class="input-prepend">
                                        <span class="add-on" href="#">
                                        <i class="icon-key"></i>
                                        </span>
                                        <input name="password" type="password" placeholder="<?php echo get_phrase('Parola');?>" autocomplete="off">
                                    </div>
                                    <div class="row-fluid">
                                        <div class="span6">
                                            <a  data-toggle="modal" href="#modal-simple"  class="btn btn-blue btn-block" >
                                                <?php echo get_phrase('Ai uitat parola?');?> 
                                            </a>
                                        </div>
                                        <div class="span6">
                                            <input type="submit" class="btn btn-gray btn-block "  value="<?php echo get_phrase('Logare');?>"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div style="color:#a5a5a5;">
                        		...
                        		<center>&copy; 2014-2015, CNNG - Manager scoala
                        		</center>
        ...
        <div id="modal-simple" class="modal hide fade" style="top:30%;">
          <div class="modal-header">
            ...
            <h6 id="modal-tablesLabel"><?php echo get_phrase('Reseteaza parola');?></h6>
          </div>
          <div class="modal-body" style="padding:20px;">
            <?php echo form_open('login/reset_password');?>
                ...
                <input type="email" name="email"  placeholder="<?php echo get_phrase('Adresa email');?>"  style="margin-bottom: 0px !important;"/>
                <input type="submit" value="<?php echo get_phrase('Reseteaza');?>"  class="btn btn-blue btn-medium"/>
            <?php echo form_close();?>
          </div>
